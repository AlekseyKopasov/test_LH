...
/* harmony import */ var _modules_init_cities_select__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-cities-select */ "./js/modules/init-cities-select.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_init_cities_select__WEBPACK_IMPORTED_MODULE_2__["initCitiesSelect"])();
  });
});
...
/***/ "./js/modules/init-cities-select.js":
/*!******************************************!*\
  !*** ./js/modules/init-cities-select.js ***!
  \******************************************/
/*! exports provided: initCitiesSelect */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCitiesSelect", function() { return initCitiesSelect; });
var select = document.querySelector('.custom-select[data-name="header-cities"]');

var initCitiesSelect = function initCitiesSelect() {
  if (!select) {
    return;
  }
